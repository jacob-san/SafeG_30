...
(function( $, window, document, undefined ) {
	 ...
	 *
	 *     // Not chained
	 *     dashboardActions.row.add( {...} );
	 *     dashboardActions.draw();
	 *
	 *     // Chained
	 *     dashboardActions.row.add( {...} ).draw();
	 *
	 * @class DataTable.Api
	 ...
	 *   var dashboardActions = $('#example').DataTable();
	 *
	 * @example
	 *   // Initialisation using a DataTables jQuery object
	 *   var dashboardActions = $('#example').dataTable().dashboardActions();
	 *
	 * @example
	 *   // Initialisation as a constructor
	 *   var dashboardActions = new $.fn.DataTable.Api( 'table.dataTable' );
	 */
	...
	DataTable.defaults = {
		 ...
		 * `dt-dashboardActions search()`, providing a delay before the search is made.
		 *  @type integer
		 *  @default 0
		 *
		 *  @dtopt Options
	...
	DataTable.ext = _ext = {
		 ...
		 *    {
		 *      return this.dashboardActions().InformationBar( col, {order:'index'} ).nodes().map( function ( td, i ) {
		 *        return $('input', td).val();
		 *      } );
		 *    }
		 */
