                ...
                <div className="register-container">
                    ...
                    <form id="form-one" noValidate="noValidate">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="form-group form-group-default">
                                    ...
                                    <input type="text" className="form-control" id="exampleInputLastName1" name="exampleInputLastName1"/>
                                </div>
                                {/*<!-- End Form Group -->*/}
                            </div>
                        </div>
                        ...
                        <div className="form-group form-group-default">
                            ...
                            <input type="email" className="form-control" id="exampleInputEmail1" name="exampleInputEmail1"/>
                        </div>
                        {/*<!-- End Form Group -->*/}
