                                ...
                                <a href="javascript:void(0)" className="">
                                    <div className="ui inline dropdown">
                                        ...
                                        <div className="menu p-md">
                                            <p className="fw-thk text-center text-uppercase ls-xs text-black">Notifications</p>
                                            <div className="item">
                                        ...
                                        <div className="profile-menu-container">
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    ...
                                                    <p className="fs-sm m-xs-t">Director at <strong><a href="javascript:void(0)"
                                                                                                   className="text-info">Absolut
                                                        Pixels</a></strong></p>
                                                    <button className="btn btn-success w-100 text-uppercase fs-sm">Connect <i
