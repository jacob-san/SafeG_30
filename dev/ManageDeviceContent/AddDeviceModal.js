                ...
                <Modal show={this.props.showModal} onHide={this.props.closeModal}>
                    ...
                    <Modal.Body>
                        <div>
                            <div className="description custom-width">
                                <form id="form-validation" className="form-horizontal" noValidate="noValidate">
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="exampleInputRequired" className="control-label col-md-3 col-xs-12">Device Name</label>
                                    ...
                                    {/*<!-- Begin Required -->*/}
                                    <div className="form-group">
                                        <label htmlFor="exampleInputRequired" className="control-label col-md-3 col-xs-12">Device Make</label>
                                        <div className="col-md-8 col-xs-12">
                                    ...
                                    {/*<!-- Begin Required -->*/}
                                    <div className="form-group">
                                        <label htmlFor="exampleInputRequired" className="control-label col-md-3 col-xs-12">Device Model</label>
                                        <div className="col-md-8 col-xs-12">
                                    ...
                                    {/*<!-- Begin Required -->*/}
                                    <div className="form-group">
                                        <label htmlFor="exampleInputRequired" className="control-label col-md-3 col-xs-12">Device Token</label>
                                        <div className="col-md-8 col-xs-12">
                                    ...
                                    {/*<!-- Begin Required -->*/}
                                    <div className="form-group">
                                        <label htmlFor="exampleInputRequired" className="control-label col-md-3 col-xs-12">Device Status</label>
                                        <div className="col-md-8 col-xs-12">
                            ...
                            {/*<button className="ui btn btn-danger w-100 deny" onClick={this.closeModal}>Close</button>*/}
